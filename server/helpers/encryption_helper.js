...
server_pub_key = ursa.createPublicKey( fs.readFileSync( './server/certs/server_rsa.pub' ) );
client_pub_key = ursa.createPublicKey( fs.readFileSync( './server/certs/client_admin_balpres.pub' ) );
client_priv_key = ursa.createPrivateKey( fs.readFileSync( './server/certs/client_admin_balpres.key.pem' ) );
